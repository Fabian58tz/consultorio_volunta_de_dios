document.addEventListener("DOMContentLoaded", function() {
    ...
    // (Esta sección se mantiene igual ya que la funcionalidad del sidebar es independiente de la tabla)
    ...
    // --- Funcionalidad de la Tabla de Pacientes ---

    // Función para añadir una nueva fila
    addRowButton.addEventListener('click', function() {
        const newRow = citasTableBody.insertRow();
        newRow.setAttribute('data-id', nextId);
        // HTML de la nueva fila adaptado a las columnas de "Tabla de Pacientes"
        newRow.innerHTML = `
            <td>${nextId}</td> <td class="editable-cell"><input type="text" value=""></td>
    ...
    function enableRowEditing(row) {
        // Apuntamos a los elementos td con la clase 'editable-cell'
        // (Nombre del Paciente, Fecha de Nacimiento, Genero)
        Array.from(row.querySelectorAll('td.editable-cell')).forEach(cell => {
